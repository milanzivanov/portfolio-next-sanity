    ...
    <>
        ...
        <div className="flex-1 flex flex-col justify-center items-center">
          <div className="container flex flex-col relative mx-auto max-w-2xl pb-20 pt-10 space-y-6 lg:max-w-4xl lg:px-12">
            <div className="prose sm:prose-lg text-gray-700 prose-a:text-gray-700 font-light text-center">
              ...
              years of experience at Vega IT Solution(two-week internship), OMA
              Adriatic, and HTEC, I specialize in crafting clean, user-friendly
              digital experiences. 🚀
      ...
      {/* <div className="w-full bg-gray-50">
        <div className="container flex items-center justify-center">
          <p className="prose sm:prose-lg text-gray-700 prose-a:text-gray-700 font-light text-center">
            Portfolio projects here... in the constraction
          </p>
        </div>
      </div> */}
    </>
