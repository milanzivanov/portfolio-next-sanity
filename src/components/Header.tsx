            ...
            <nav>
              ...
              >
                ...
                <li className="sm:before:w-[1px] hidden  sm:before:bg-gray-200 before:block md:flex sm:gap-4 md:gap-6">
                  <Link
                    className="rounded-full flex gap-4 items-center bg-blue-500 dark:bg-blue-700 hover:bg-blue-600 focus:bg-blue-400 active:bg-blue-600 h-10 px-4 sm:px-6 justify-center text-white dark:hover:text-white transition-colors duration-200"
