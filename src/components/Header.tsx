            ...
            <nav>
              ...
              >
                ...
                <li className="hidden md:flex">
                  <Link
                    className="rounded-full flex gap-2 items-center bg-black dark:bg-white hover:opacity-80 h-7 px-3 lg:h-10 lg:px-5 justify-center text-white dark:text-black transition-opacity duration-200 focus-visible:outline-dashed focus-visible:outline-2 focus-visible:outline-offset-3"
