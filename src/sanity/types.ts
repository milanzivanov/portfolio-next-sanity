...
// Query: *[_type == "project" && defined(slug.current)] | order(publishedAt desc) {  _id,  title,  slug,  mainImage,  publishedAt,  url,  "categories": coalesce(    categories[]->{      _id,      slug,      title    },    []  ),  author->{    name,    image  },    "technologies": technologies[]->{      _id,      name,      slug,      icon,      level,      category,      description,      yearsExperience    }  }
